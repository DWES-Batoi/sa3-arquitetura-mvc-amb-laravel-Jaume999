...
<div class="max-w-5xl mx-auto">
  <h1 class="text-3xl font-bold text-purple-800 mb-6">Guia de Partits</h1>
  ...
  <div class="mb-6">
    <a href="{{ route('partits.create') }}" 
       class="inline-flex items-center px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded shadow-sm transition focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
        ...
        @forelse($partits as $key => $partit)
          <tr class="hover:bg-gray-50 transition-colors">
            ...
            <td class="p-3">
              ...
              @else
                <span class="inline-flex items-center px-2 py-0.5 rounded font-mono font-bold bg-purple-600 text-white">
                  {{ $partit['resultat'] }}
                </span>
              @endif
            </td>
