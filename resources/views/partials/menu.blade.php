<nav>
  <ul class="flex space-x-4">
    ...
    <li><a class="text-white hover:underline" href="{{ route('jugadores.index') }}">Guia de jugadores</a></li>
    <li><a class="text-white hover:underline" href="{{ route('partits.index') }}">Guia de partits</a></li>
  </ul>
</nav>